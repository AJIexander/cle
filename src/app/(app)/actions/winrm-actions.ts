...
${timestamp} - Authenticated successfully as '${username}'.
...
${timestamp} - Cleaning User temp folder: C:\\Users\\${userAccount}\\AppData\\Local\\Temp\\*
${timestamp} - Successfully cleaned ${Math.floor(Math.random() * 300) + 20} items from User Temp. Space freed: ${simCleanedUserTemp} MB.
${timestamp} - Cleaning files older than 30 days from Downloads folder: C:\\Users\\${userAccount}\\Downloads
